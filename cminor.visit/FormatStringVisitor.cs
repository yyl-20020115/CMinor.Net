...
internal class FormatStringVisitor : Visitor
{
    ...
    private List<Expression> actualArguments = new();
    ...
    public FormatStringVisitor(StringBuilder P_0, List<Expression> P_1, StringTable P_2, Program P_3, ErrorLogger P_4)
    {
        result = P_0;
